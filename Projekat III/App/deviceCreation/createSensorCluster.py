...
def createValueDescriptors():
    ...
    payload = {
        "name": "Turbidity",
        "description": "Amount of turbidity in water",
        "min": "1",
        "max": "7",
        "type": "Float64",
        "uomLabel": "tr",
...
def addNewDevice():
    ...
    payload = {
        "name": "water_potability_sensor_cluster_01",
        ...
        "labels": ["PH sensor", "Organic carbon sensor", "Turbidity sensor"],
        "location": "Nis",
                    "service": {
